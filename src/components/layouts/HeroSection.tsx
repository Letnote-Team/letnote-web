...
export const HeroSection = () => (
  <section className="flex justify-between pl-4 xl:pl-20 2xl:pl-64 ">
    <div className="absolute top-0 right-0 -z-10">
      <svg
        className="2xl:w-[800px] w-[700px] aspect-[566/460]"
    ...
    <div className="relative w-[650px] h-[450px] 2xl:mx-28 mx-16">
      <div className="absolute left-60 animate-[float_5s_ease-in-out_infinite] ">
        <Image
          className="2xl:w-80 w-72 aspect-[250/361]"
          src="/imgs/robot.png"
          alt="Robô mexendo no computador"
        />
      </div>
      <div className="absolute left-16 2xl:bottom-10 bottom-24 animate-[float_3s_ease-in-out_infinite]">
        <Image
          className="2xl:w-32 w-24 aspect-[330/361]"
          src="/imgs/hand.png"
          alt="Mãos tocando através do celular"
        />
      </div>
      <div className="absolute top-6 left-32 animate-[float_2.5s_ease-in-out_infinite]">
        <Image
          className="2xl:w-20 w-16 aspect-[1391/1721]"
          src="/imgs/note.png"
          alt="Um bloco de notas"
        />
      </div>
      <div className="absolute bottom-0 right-0 animate-[float_2s_ease-in-out_infinite]">
        <Image
          className="2xl:w-24 w-20 aspect-[285/361]"
